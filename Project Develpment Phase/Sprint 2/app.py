...
app = Flask(__name__)
UPLOAD_FOLDER = 'D:\HANDWRITTEN DIGIT RECOGNITION\PROJECT DEVELOPMENT PHASE\SPRINT 1\models'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

model = load_model("D:\HANDWRITTEN DIGIT RECOGNITION\PROJECT DEVELOPMENT PHASE\SPRINT 1\models\mnistCNN.h5")
